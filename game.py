...
class CheckBox(engine.GameObject):
    ...
    def draw(self):
        ...
        checkbox_rect = Rectangle(self.center - Vector2(checkbox_size, checkbox_size) / 2,
                                  Vector2(checkbox_size, checkbox_size))
        text_size = self.font.size(self.text)
        container_rect = Rectangle(self.center - Vector2((text_size[0] + checkbox_size) / 2 - 20, text_size[1] + 10) / 2,
                                   Vector2((checkbox_size + text_size[0] + 40), text_size[1] + 10))
        ...
        # Draw text
        text_position = Vector2(self.center.x + checkbox_size / 2 + 10, self.center.y - self.font.get_height() / 2)
        self.game.renderer.draw_text(self.text, text_position, (255, 255, 255), self.font)
...
class MenuState(engine.GameState):
    ...
    def initialize(self):
        ...
        #checkbox test
        checkbox = CheckBox(self, Vector2(self.game.resolution[0] / 2, 200), Vector2(50, 50), "Test", font, (133, 133, 133), (200, 200, 200), (230, 230, 230))
        checkbox.on_click = lambda: print("Checkbox clicked")
